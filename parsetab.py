...
_lr_productions = [
  ...
  ('letStatement -> LET varName LSQUARE expression RSQUARE EQ expression SEMICOLON','letStatement',8,'p_letStatementArray','jackyacc.py',119),
  ...
  ('term -> varName','term',1,'p_termVarRef','jackyacc.py',175),
  ('term -> keywordConstant','term',1,'p_termKeywordConstant','jackyacc.py',179),
  ('term -> STRING_CONST','term',1,'p_termStringConst','jackyacc.py',183),
  ('term -> varName LSQUARE expression RSQUARE','term',4,'p_termArrayRef','jackyacc.py',187),
  ('subroutineCall -> subroutineName LPAREN expressionList RPAREN','subroutineCall',4,'p_subroutineCall','jackyacc.py',191),
  ('subroutineCall -> className DOT subroutineName LPAREN expressionList RPAREN','subroutineCall',6,'p_subroutineCall','jackyacc.py',192),
  ('subroutineCall -> varName DOT subroutineName LPAREN expressionList RPAREN','subroutineCall',6,'p_subroutineCall','jackyacc.py',193),
  ('expressionList -> expression commaExpressions','expressionList',2,'p_expressionList','jackyacc.py',200),
  ('expressionList -> empty','expressionList',1,'p_expressionListEmpty','jackyacc.py',204),
  ('commaExpressions -> COMMA expression commaExpressions','commaExpressions',3,'p_commaExpressions','jackyacc.py',208),
  ('commaExpressions -> empty','commaExpressions',1,'p_commaExpressionsEmpty','jackyacc.py',212),
  ('op -> PLUS','op',1,'p_op','jackyacc.py',216),
  ('op -> MINUS','op',1,'p_op','jackyacc.py',217),
  ('op -> TIMES','op',1,'p_op','jackyacc.py',218),
  ('op -> DIVIDE','op',1,'p_op','jackyacc.py',219),
  ('op -> AMP','op',1,'p_op','jackyacc.py',220),
  ('op -> PIPE','op',1,'p_op','jackyacc.py',221),
  ('op -> LT','op',1,'p_op','jackyacc.py',222),
  ('op -> GT','op',1,'p_op','jackyacc.py',223),
  ('op -> EQ','op',1,'p_op','jackyacc.py',224),
  ('unaryOp -> MINUS','unaryOp',1,'p_unaryOp','jackyacc.py',228),
  ('unaryOp -> TILDE','unaryOp',1,'p_unaryOp','jackyacc.py',229),
  ('keywordConstant -> TRUE','keywordConstant',1,'p_keywordConstant','jackyacc.py',233),
  ('keywordConstant -> FALSE','keywordConstant',1,'p_keywordConstant','jackyacc.py',234),
  ('keywordConstant -> NULL','keywordConstant',1,'p_keywordConstant','jackyacc.py',235),
  ('keywordConstant -> THIS','keywordConstant',1,'p_keywordConstant','jackyacc.py',236),
  ('empty -> <empty>','empty',0,'p_empty','jackyacc.py',240),
]
